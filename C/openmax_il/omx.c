...
const char * omx_index_to_string (OMX_INDEXTYPE index)
{
  switch (index) {
...
{
  switch (f) {
	case OMX_VIDEO_CodingUnused: return "N/A";
	case OMX_VIDEO_CodingAutoDetect: return "Autodetection";
	case OMX_VIDEO_CodingMPEG2: return "H.262";
	case OMX_VIDEO_CodingH263: return "H.263";
	case OMX_VIDEO_CodingMPEG4: return "MPEG-4";
	case OMX_VIDEO_CodingWMV: return "WMV";
	case OMX_VIDEO_CodingRV: return "Real Video";
...
const char *omx_color_format_to_string(OMX_COLOR_FORMATTYPE f)
{
  switch ((int)f) {
	...
	case OMX_COLOR_Format8bitRGB332: return "8bitRGB332";
	case OMX_COLOR_Format12bitRGB444: return "12bitRGB444";
	case OMX_COLOR_Format16bitARGB4444: return "16bitARGB4444";
	case OMX_COLOR_Format16bitARGB1555: return "16bitARGB1555";
	case OMX_COLOR_Format16bitRGB565: return "16bitRGB565";
	case OMX_COLOR_Format16bitBGR565: return "16bitBGR565";
	case OMX_COLOR_Format18bitRGB666: return "18bitRGB666";
	case OMX_COLOR_Format18bitARGB1665: return "18bitARGB1665";
	case OMX_COLOR_Format19bitARGB1666: return "19bitARGB1666";
	case OMX_COLOR_Format24bitRGB888: return "24bitRGB888";
	case OMX_COLOR_Format24bitBGR888: return "24bitBGR888";
	case OMX_COLOR_Format24bitARGB1887: return "24bitARGB1887";
	case OMX_COLOR_Format25bitARGB1888: return "25bitARGB1888";
	case OMX_COLOR_Format32bitBGRA8888: return "32bitBGRA8888";
	case OMX_COLOR_Format32bitARGB8888: return "32bitARGB8888";
	case OMX_COLOR_FormatYUV411Planar: return "YUV411Planar";
	case OMX_COLOR_FormatYUV411PackedPlanar: return "YUV411PackedPlanar";
	case OMX_COLOR_FormatYUV420Planar: return "YUV420Planar";
	case OMX_COLOR_FormatYUV420PackedPlanar: return "YUV420PackedPlanar";
	case OMX_COLOR_FormatYUV420SemiPlanar: return "YUV420SemiPlanar";
	case OMX_COLOR_FormatYUV422Planar: return "YUV422Planar";
	case OMX_COLOR_FormatYUV422PackedPlanar: return "YUV422PackedPlanar";
	case OMX_COLOR_FormatYUV422SemiPlanar: return "YUV422SemiPlanar";
	...
	case OMX_COLOR_FormatYUV444Interleaved: return "YUV444Interleaved";
	case OMX_COLOR_FormatRawBayer8bit: return "RawBayer8bit";
	case OMX_COLOR_FormatRawBayer10bit: return "RawBayer10bit";
	case OMX_COLOR_FormatRawBayer8bitcompressed: return "RawBayer8bitcompressed";
	...
	case OMX_COLOR_FormatYUV420PackedSemiPlanar: return "YUV420PackedSemiPlanar";
	case OMX_COLOR_FormatYUV422PackedSemiPlanar: return "YUV422PackedSemiPlanar";
	case OMX_COLOR_Format18BitBGR666: return "18BitBGR666";
	case OMX_COLOR_Format24BitARGB6666: return "24BitARGB6666";
	case OMX_COLOR_Format24BitABGR6666: return "24BitABGR6666";
	case OMX_COLOR_FormatAndroidOpaque: return "AndroidOpaque";
	default: return "N/A";
  }
}
...
const char *omx_err2str(OMX_ERRORTYPE err)
{
  switch (err) {
	...
	case OMX_ErrorInsufficientResources: return "Insufficient resources";
	case OMX_ErrorUndefined: return "Undefined";
	case OMX_ErrorInvalidComponentName: return "Invalid component name";
	case OMX_ErrorComponentNotFound: return "Component not found";
	case OMX_ErrorInvalidComponent: return "Invalid component";
	case OMX_ErrorBadParameter: return "Bad parameter";
	case OMX_ErrorNotImplemented: return "Not implemented";
	case OMX_ErrorUnderflow: return "Underflow";
	case OMX_ErrorOverflow: return "Overflow";
	case OMX_ErrorHardware: return "Hardware";
	case OMX_ErrorInvalidState: return "Invalid state";
	case OMX_ErrorStreamCorrupt: return "Stream corrupt";
	case OMX_ErrorPortsNotCompatible: return "Ports not compatible";
	case OMX_ErrorResourcesLost: return "Resources lost";
	case OMX_ErrorNoMore: return "No more";
	case OMX_ErrorVersionMismatch: return "Version mismatch";
	case OMX_ErrorNotReady: return "Not ready";
	case OMX_ErrorTimeout: return "Timeout";
	case OMX_ErrorSameState: return "Same state";
	case OMX_ErrorResourcesPreempted: return "Resources preempted";
	case OMX_ErrorPortUnresponsiveDuringAllocation: return "Port unresponsive during allocation";
	case OMX_ErrorPortUnresponsiveDuringDeallocation: return "Port unresponsive during deallocation";
	case OMX_ErrorPortUnresponsiveDuringStop: return "Port unresponsive during stop";
	case OMX_ErrorIncorrectStateTransition: return "Incorrect state transition";
	case OMX_ErrorIncorrectStateOperation: return "Incorrect state operation";
	case OMX_ErrorUnsupportedSetting: return "Unsupported setting";
	case OMX_ErrorUnsupportedIndex: return "Unsupported index";
	case OMX_ErrorBadPortIndex: return "Bad port index";
	case OMX_ErrorPortUnpopulated: return "Port unpopulated";
	case OMX_ErrorComponentSuspended: return "Component suspended";
	case OMX_ErrorDynamicResourcesUnavailable: return "Dynamic resources unavailable";
	case OMX_ErrorMbErrorsInFrame: return "Macroblock errors in frame";
	case OMX_ErrorFormatNotDetected: return "Format not detected";
	case OMX_ErrorContentPipeOpenFailed: return "Content pipe open failed";
	case OMX_ErrorContentPipeCreationFailed: return "Content pipe creation failed";
	case OMX_ErrorSeperateTablesUsed: return "Separate tables used";
	case OMX_ErrorTunnelingUnsupported: return "Tunneling unsupported";
	default:
	  if (err >= OMX_ErrorKhronosExtensions && err < OMX_ErrorVendorStartUnused) {
		return "Khronos extension error";
	  } else if (err >= OMX_ErrorVendorStartUnused && err < OMX_ErrorMax) {
...
{
  switch (cmd) {
	case OMX_CommandStateSet: return "SetState";
	case OMX_CommandFlush: return "Flush";
	case OMX_CommandPortDisable: return "DisablePort";
	case OMX_CommandPortEnable: return "EnablePort";
...
OMX_ERRORTYPE GetParameter(OMX_HANDLETYPE handle, OMX_INDEXTYPE index, OMX_PTR param)
{
  ...
  if (err != OMX_ErrorNone && err != OMX_ErrorNoMore) {
	fatal("%s for index: 0x%x(%s) failed :%s (0x%08x)\n", __func__,
		index, omx_index_to_string(index), omx_err2str (err), err);
  }
  ...
  for (i = 0; i < n; i++) {
	...
	if (err != OMX_ErrorNone) {
	  fatal("Failed to allocate buffer for %s port %lu: %s (0x%08x)\n", comp->name,
		  port_index, omx_err2str (err), err);
	}
  }
  ...
  *bufs_num = n;
  ...
  for (i = 0; i < n; i++) {
	...
	printf("%s: allocated buffer %p, out port index: %lu, in port index: %lu\n",
		comp->name, omx_buf[i]->pBuffer, omx_buf[i]->nOutputPortIndex, omx_buf[i]->nInputPortIndex);
#endif
  }
...
void CompSetBitrate(struct Comp *comp, OMX_U32 port_index, OMX_U32 bitrate)
{
  ...
  if (err != OMX_ErrorNone) {
	printf("%s failed :%s\n", omx_index_to_string(index), omx_err2str (err));
  }
...
void PortSetEnable(struct Comp *comp, OMX_U32 port_index, OMX_BOOL enable)
{
  ...
  if (err != OMX_ErrorNone) {
	fatal("Failed to send enable/disable command to %s port %lu: %s (0x%08x)",
		comp->name, port_index, omx_err2str (err), err);
  }
}
